...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Thông Tin Phim</h2>
        </div>

        <form action="{{ route('admin.movies.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select id="rating_code" name="rating_code"
                        ...
                        <option value="P" {{ old('rating_code') === 'P' ? 'selected' : '' }}>P - Phổ biến</option>
                        <option value="C13" {{ old('rating_code') === 'C13' ? 'selected' : '' }}>C13 - Cấm dưới 13 tuổi</option>
                        <option value="C16" {{ old('rating_code') === 'C16' ? 'selected' : '' }}>C16 - Cấm dưới 16 tuổi</option>
                        <option value="C18" {{ old('rating_code') === 'C18' ? 'selected' : '' }}>C18 - Cấm dưới 18 tuổi</option>
                    </select>
                </div>
            </div>
